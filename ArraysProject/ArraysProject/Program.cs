    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < testScores.Length; i++)
            {
                ...
                if (i == 9)
                {
                    userScoreAverage = (testScores[0] + testScores[1] + testScores[2] + testScores[3] + testScores[4] + testScores[5] + testScores[6] + testScores[7] + testScores[8] + testScores[9]) / 10;
                    Console.WriteLine($"Your average testscore is {userScoreAverage}");

                        if (userScoreAverage < 80)
                        {
